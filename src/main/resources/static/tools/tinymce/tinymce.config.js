tinymce.init({
   ...
   // width: '70%',
    ...
    theme_advanced_font_sizes: "10px,12px,13px,14px,16px,18px,20px",
        ...
        content_css : "http://localhost/laravel-ads/public/tools/tinymce/custom_content.css",
    font_formats: 
                "Default=Tahoma, Arial, Helvetica, Tahoma, Verdana, sans-serif;"+
                "هما=BHoma;کودک=BKoodakBold",
